                ...
                <div className=' rounded-lg shadow-md overflow-hidden hover:shadow-xl  p-8 hover:scale-105 transform transition-all duration-500 ease-in-out'>
                    <div className='flex justify-between '>
                        <div className='flex gap-4'>
                            ...
                            <div>
                                <h1 className='font-bold text-5xl'>Awlad Hossain</h1>
                                <p className='font-semibold text-xl'>Businessman</p>
                            </div>
                        </div>
                        <Image src={image3} height={60} width={60} className='text-[#FF3811]' alt='image-1'></Image>
                    </div>
                ...
                <div className=' rounded-lg shadow-md overflow-hidden hover:shadow-xl p-8 hover:scale-105 transform transition-all duration-500 ease-in-out'>
                    <div className='flex justify-between'>
                        <div className='flex gap-4'>
                            ...
                            <div>
                                <h1 className='font-bold text-5xl'>Irfan Hossain</h1>
                                <p className='font-semibold text-xl'>Businessman</p>
                            </div>
                        </div>
                        <Image src={image3} height={60} width={60} className='text-[#FF3811]' alt='image-1'></Image>
